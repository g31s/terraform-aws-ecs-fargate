    ...
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "metrics": [
                    [ "AWS/NetworkELB", "ProcessedBytes", "AvailabilityZone", "${az_first}", "LoadBalancer", "${loadbalancer}" ],
                    [ "...", "${az_second}", ".", "." ]
                ],
                "region": "${region}"
            }
        },
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "metrics": [
                    [ "AWS/NetworkELB", "NewFlowCount", "AvailabilityZone", "${az_first}", "LoadBalancer", "${loadbalancer}" ],
                    [ "...", "${az_second}", ".", "." ]
                ],
                "region": "${region}"
            }
