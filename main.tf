...
data "template_file" "service_tmp" {
  ...
  vars = {
    ...
    app_image           = var.app_image == "none" ? (var.virtual_gateway_arn != "none" ? "" : aws_ecr_repository.ecr_repo[0].repository_url) : var.app_image
...
resource "aws_ecs_task_definition" "main" {
  ...
  dynamic "proxy_configuration" {
    for_each = var.virtual_gateway_arn == "none" ? [1] : []
    content {
      // container name
